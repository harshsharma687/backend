...
// Static assets: HTML/JS/CSS must always revalidate (ETag still allows 304),
// otherwise a deployed UI can silently run a stale cached app.js for days.
...
app.use((error, req, res, next) => {
    ...
    // Mongoose throws CastError (500 by default) on malformed ids; clients
    // should see a clean 404 instead of a server error.
